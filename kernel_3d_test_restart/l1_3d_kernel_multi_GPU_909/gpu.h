//parameter settings 
//#define CPU  	// if defined, CPU will compute and compare its results with GPU
#define MULTI_GPUS //if defined, multipule GPU are used
//#define GPU_PRINT //ifdefined, GPU will print a lot of information which is really annoying
#define GPU
#define GPU_FILE
//#define CPU_FILE
...
#define TS (1000)
#define Steps_write_back (10) // Every () steps, data write back from GPU to CPU for correlation
...
extern "C" void rtm_gpu_func(int ny, int nz, int nx, 
	...
	float * debug, float* gpu_kernel_time_ps, float *source);
