...
//	__shared__ float sh_g_ex_Vx0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_Vy0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_Vz0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmaxx0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmayy0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmazz0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmaxy0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmayz0_now[(TX+10)*(TZ+10)*3];
//	__shared__ float sh_g_ex_sigmaxz0_now[(TX+10)*(TZ+10)*3];
//
//
