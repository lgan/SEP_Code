...
{	
	...
	for(int i=0; i<n_gpus; i++){
		...
		rtm_gpu_kernel<<<dimGrid_halo, dimBlock,0,stream_halo[i]>>>(ny, nz, nx,
			g_ex_Vy0_in, g_ex_Vx0_in[i] + offset_halo_up, g_ex_Vz0_in, g_ex_sigmayy0_in[i] + offset_halo_up, g_ex_sigmaxx0_in[i] + offset_halo_up, g_ex_sigmazz0_in[i] + offset_halo_up, g_ex_sigmaxy0_in[i] + offset_halo_up, g_ex_sigmaxz0_in[i] + offset_halo_up, g_ex_sigmayz0_in[i] + offset_halo_up,
			g_ex_Vy0_in1, g_ex_Vx0_in1[i] + offset_halo_up, g_ex_Vz0_in1, g_ex_sigmayy0_in1, g_ex_sigmaxx0_in1, g_ex_sigmazz0_in1, g_ex_sigmaxy0_in1, g_ex_sigmaxz0_in1, g_ex_sigmayz0_in1,
			g_ex_Vy0_out, g_ex_Vx0_out[i] + offset_halo_up, g_ex_Vz0_out, g_ex_sigmayy0_out, g_ex_sigmaxx0_out, g_ex_sigmazz0_out, g_ex_sigmaxy0_out, g_ex_sigmaxz0_out, g_ex_sigmayz0_out,
		...
		fprintf(stderr, "Halo computing, GPU id %d\n", i);
		rtm_gpu_kernel<<<dimGrid_halo, dimBlock,0,stream_halo[i]>>>(ny, nz, nx,
			g_ex_Vy0_in, g_ex_Vx0_in[i] + offset_halo_bt, g_ex_Vz0_in, g_ex_sigmayy0_in[i] + offset_halo_bt, g_ex_sigmaxx0_in[i] + offset_halo_bt, g_ex_sigmazz0_in[i] + offset_halo_bt, g_ex_sigmaxy0_in[i] + offset_halo_bt, g_ex_sigmaxz0_in[i] + offset_halo_bt, g_ex_sigmayz0_in[i] + offset_halo_bt,
			g_ex_Vy0_in1, g_ex_Vx0_in1[i] + offset_halo_bt, g_ex_Vz0_in1, g_ex_sigmayy0_in1, g_ex_sigmaxx0_in1, g_ex_sigmazz0_in1, g_ex_sigmaxy0_in1, g_ex_sigmaxz0_in1, g_ex_sigmayz0_in1,
			g_ex_Vy0_out, g_ex_Vx0_out[i] + offset_halo_bt, g_ex_Vz0_out, g_ex_sigmayy0_out, g_ex_sigmaxx0_out, g_ex_sigmazz0_out, g_ex_sigmaxy0_out, g_ex_sigmaxz0_out, g_ex_sigmayz0_out,
	...
	for(int i=0; i<n_gpus; i++){
		...
		rtm_gpu_kernel<<<dimGrid_internal, dimBlock,0,stream_internal[i]>>>(ny, nz, nx,
			g_ex_Vy0_in, g_ex_Vx0_in[i] + offset_internal, g_ex_Vz0_in, g_ex_sigmayy0_in[i] + offset_internal, g_ex_sigmaxx0_in[i] + offset_internal, g_ex_sigmazz0_in[i] + offset_internal, g_ex_sigmaxy0_in[i] + offset_internal, g_ex_sigmaxz0_in[i] + offset_internal, g_ex_sigmayz0_in[i] + offset_internal,
			g_ex_Vy0_in1, g_ex_Vx0_in1[i] + offset_internal, g_ex_Vz0_in1, g_ex_sigmayy0_in1, g_ex_sigmaxx0_in1, g_ex_sigmazz0_in1, g_ex_sigmaxy0_in1, g_ex_sigmaxz0_in1, g_ex_sigmayz0_in1,
		g_ex_Vy0_out, g_ex_Vx0_out[i] + offset_internal, g_ex_Vz0_out, g_ex_sigmayy0_out, g_ex_sigmaxx0_out, g_ex_sigmazz0_out, g_ex_sigmaxy0_out, g_ex_sigmaxz0_out, g_ex_sigmayz0_out,
